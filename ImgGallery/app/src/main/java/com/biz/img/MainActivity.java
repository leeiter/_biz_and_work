...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // 지금붙너 이미지 저장 폴더에 접근을 하겠다 라는 설정
                imgIntent.setType(MediaStore.Images.Media.CONTENT_TYPE);

                // 이미지를 저장하는 공간
                // 내장메모리, 외장 SD 카드가 있는데 모두 나에게 접근할 수 있게 해달라
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == RequestCode.REQUEST_IMAGE_CODE) {
            ...
            if(requestCode == RequestCode.RESULT_OK) {
                // 회색으로 변하는 것은 필요 없는 코드라고 알려주는 것.
            ...
            } else if(requestCode == RequestCode.RESULT_ERROR) {
                Toast.makeText(MainActivity.this,
                        "입력 오류 발생!!", Toast.LENGTH_SHORT).show();
            }
        }
    }
