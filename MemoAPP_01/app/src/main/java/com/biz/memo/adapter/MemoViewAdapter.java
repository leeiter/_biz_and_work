...
public class MemoViewAdapter extends RecyclerView.Adapter {
    ...
    // interface 는 실질적으로 연결통로가 된다.
    // 삭제버튼에 사용할 이벤트 인터페이스를 하나 생성하고
    // 내용이 없는 이벤트 method를 선언 해 두었다.
    ...
    public MemoViewAdapter(Context context, List<MemoVO> memoList) {
        ...
        // context 변수 같은 context 생성자로 토스하여
        // 그곳에서 layoutInglater를 초기화 하도록 코드를 단일화 한다.
    ...
    @NonNull // null 값을 절대 넣을 수 없다.
    @Override
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // memo_item.xml 파일을 가져와서 view 객체로 생성(확장)하기
    ...
    */
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        */
        ...
        // 화면에 보이는아이템만 삭제하는 이벤트 코드
        // 실제 DB,에 데이터를 삭제를 수행해야 정상적인 처리가 되는데
